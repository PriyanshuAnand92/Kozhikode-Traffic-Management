        ...
        <div className="pointer-events-auto absolute inset-x-0 bottom-0 z-30 flex flex-col rounded-t-2xl border-t border-[var(--border)] bg-[var(--surface)] shadow-2xl lg:hidden" style={{ maxHeight: '70%' }}>
          ...
          <div className="flex-1 overflow-y-auto p-4 pb-24 space-y-3">
            <div className="grid grid-cols-2 gap-3">
              <MetricCard label="Officers on duty" value="6" />
              <MetricCard label="Broadcast" value="Ready" />
            </div>
            <div className="flex gap-2 pt-2">
              <button type="button" className="flex-1 rounded-[10px] bg-[var(--accent)] py-3 text-[13px] font-semibold text-white">
                Approve Response
              </button>
              <button type="button" className="flex-1 rounded-[10px] border border-[var(--border)] py-3 text-[13px] font-semibold text-[var(--text)]">
                Broadcast Alert
              </button>
            </div>
          </div>
